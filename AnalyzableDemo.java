...
/**
 * This program corresponds to Programming challenge #6
 * which demonstrates the CourseGrades class modified
 * to accept the Analyzable interface.
 * 
 * @author craig
 * 6/17/21
 * At home with Maria
...
public class AnalyzableDemo {
	public static void main(String[]args) {
		// This is a copy of the CourseGradesDemo code
		...
		/*
		Results of the Analyzable interface added to the
		CourseGrades class.
		*/
		System.out.println("Results of the Analyzable interface\n"
			+ "Average of scores: " + courseGrades.getAverage() + "\n"
			+ "Highest score: " + courseGrades.getHighest() + "\n"
			+ "Lowest score: " + courseGrades.getLowest() + "\n");
	}	
}
