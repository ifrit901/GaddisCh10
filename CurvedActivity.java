...
/**
 * This is code listing 10-13, the curved activity class.
 * It extends the GradedActivity class and overrides the 
 * setScore method.
 * 
 * @author craig
 */
public class CurvedActivity extends GradedActivity {
	 ...
	 * @param percentage The curve percentage.
	 */
	 ...
	 * This version accepts the unadjusted score as an argument. That score 
	 * is multiplied by the curve percentage and the result is sent as an argument
